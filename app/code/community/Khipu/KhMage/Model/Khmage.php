...
class Khipu_KhMage_Model_KhMage extends Mage_Payment_Model_Method_Abstract
{

    // unique internal payment method identifier
    protected $_code = 'khmage';
    ...
    public function getOrderPlaceRedirectUrl() {
        return Mage::getUrl('khmage/payment/choosebank', array('_secure' => true));
    }
}
?>